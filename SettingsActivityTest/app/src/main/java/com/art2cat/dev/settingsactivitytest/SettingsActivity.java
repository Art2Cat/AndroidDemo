...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceClickListener {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            Preference switchPreference = findPreference("security_switch");
            switchPreference.setOnPreferenceClickListener(this);
            mPin = findPreference("pin");
            mPassword = findPreference("password");
            mPattern = findPreference("pattern");
            mPin.setOnPreferenceClickListener(this);
            mPassword.setOnPreferenceClickListener(this);
            mPattern.setOnPreferenceClickListener(this);
        }
